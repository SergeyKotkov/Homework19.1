                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-success rounded-pill">Купить</button>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="collapse" id="collapseExample1">
                                    <div class="card card-body">
                                        Исключительно за деньги!<strong>Натурой не принимаем!</strong>
                                    </div>
                                </div>
                                <div class="collapse" id="collapseExample2">
                                    <div class="card card-body">
                                        На ковре-самолете Алладина или летающей машине Гарри Поттера <strong>Электросамокаты
                                        не используем!</strong>
                                    </div>
                                </div>
                                <div class="collapse" id="collapseExample">
                                    <div class="card card-body">
                                        За качество отвечаю! Клянусь здоровьем мужа! Правда его нет, только жена. Но,
                                        если
                                        бы был муж-поклялся бы его здоровьем)))
                                    </div>
                                </div>
                            </div>
                        </div>
